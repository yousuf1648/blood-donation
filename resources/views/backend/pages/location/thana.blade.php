      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">All Thanas</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="col-lg-7 col-7">
          ...
          <div class="card card-success">
            <div class="card-header">
              <h3 class="card-title">All Thanas</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                    ...
                    @foreach ($thanas as $key=>$thana)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.thana.delete',$thana->id) }}" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                            ...
                            <div class="modal-dialog" role="document">
                                <form action="{{ route('admin.thana.update',$thana->id) }}" method="POST">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <h5 class="modal-title" id="exampleModalLabel">Thana Name Edit - <strong>{{ $thana->thana_name }}</strong></h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="thana_name">Name</label>
                                                <input type="text" class="form-control" id="thana_name" name="thana_name" value="{{ $thana->thana_name }}" placeholder="Enter Division Name">
                                            </div>
                                        </div>
          ...
          <!-- small box -->
            ...
            @csrf
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">New Thana</h3>
                    </div>
                    <div class="card-body">
                        ...
                        @if ($errors->has('dis_id'))
                            <div class="invalid-feedback" style="display: block !important;">
                                District is erquired!
                            </div>
                        @endif

                        <div class="form-group">
                            <label for="thana_name">Thana Name</label>
                            <input type="text" class="form-control" id="thana_name" name="thana_name" placeholder="Enter Thana Name">
                        </div>
                        @if ($errors->has('thana_name'))
                            <div class="invalid-feedback" style="display: block !important;">
                                Thana name is erquired!
                            </div>
                        @endif
